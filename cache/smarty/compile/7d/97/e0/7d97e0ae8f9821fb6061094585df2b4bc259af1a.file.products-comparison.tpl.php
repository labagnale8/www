<?php /* Smarty version Smarty-3.1.19, created on 2017-01-12 15:57:10
         compiled from "/home/admiraltza/www/themes/jms_delphinus/products-comparison.tpl" */ ?>
<?php /*%%SmartyHeaderCode:110559980758779946b9d625-66427530%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7d97e0ae8f9821fb6061094585df2b4bc259af1a' => 
    array (
      0 => '/home/admiraltza/www/themes/jms_delphinus/products-comparison.tpl',
      1 => 1482999907,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '110559980758779946b9d625-66427530',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5877994702f4f0_24534272',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5877994702f4f0_24534272')) {function content_5877994702f4f0_24534272($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/admiraltza/www/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_cycle')) include '/home/admiraltza/www/tools/smarty/plugins/function.cycle.php';
?>
		...
		<table id="product_comparison" class="table table-bordered">
			<tr>
				<td class="td_empty compare_extra_information">
					<span><?php echo smartyTranslate(array('s'=>'Product Image:'),$_smarty_tpl);?>
</span>
				</td>
...
">
			...
			<tr class="compare_condition">
				<td class="td_empty compare_extra_information">
					<span><?php echo smartyTranslate(array('s'=>'Condition:'),$_smarty_tpl);?>
</span>
				</td>
				<?php  $_smarty_tpl->tpl_vars['product'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['product']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['products']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
">
			...
			<tr>
				<td class="td_empty compare_extra_information">
					<span><?php echo smartyTranslate(array('s'=>'Unit Price:'),$_smarty_tpl);?>
</span>
				</td>
				<?php  $_smarty_tpl->tpl_vars['product'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['product']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['products']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1) {?>
										<span class="old-price product-price old price">
 ...
 <?php echo smartyTranslate(array('s'=>'per %s','sprintf'=>htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->unity, ENT_QUOTES, 'UTF-8', true)),$_smarty_tpl);?>
			...
			<tr>
				<td class="td_empty compare_extra_information">
					<span><?php echo smartyTranslate(array('s'=>'Description:'),$_smarty_tpl);?>
</span>
				</td>
				<?php  $_smarty_tpl->tpl_vars['product'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['product']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['products']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
			...
			<tr>
				<td class="td_empty compare_extra_information">
					<span><?php echo smartyTranslate(array('s'=>'Manufacturer:'),$_smarty_tpl);?>
</span>
				</td>
				<?php  $_smarty_tpl->tpl_vars['product'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['product']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['products']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
			...
			<tr>
				<td class="td_empty compare_extra_information">
					<span><?php echo smartyTranslate(array('s'=>'Availability:'),$_smarty_tpl);?>
</span>
				</td>
				<?php  $_smarty_tpl->tpl_vars['product'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['product']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['products']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
			...
			<tr>
				<td class="td_empty compare_extra_information">
					<span><?php echo smartyTranslate(array('s'=>'Action:'),$_smarty_tpl);?>
</span>
				</td>
				<?php  $_smarty_tpl->tpl_vars['product'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['product']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['products']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
								...
								<div class="button-container">
									<?php if ((!$_smarty_tpl->tpl_vars['product']->value->hasAttributes()||(isset($_smarty_tpl->tpl_vars['add_prod_display']->value)&&($_smarty_tpl->tpl_vars['add_prod_display']->value==1)))&&$_smarty_tpl->tpl_vars['product']->value->minimal_quantity==1&&$_smarty_tpl->tpl_vars['product']->value->customizable!=2&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
										<?php if (($_smarty_tpl->tpl_vars['product']->value->quantity>0||$_smarty_tpl->tpl_vars['product']->value->allow_oosp)) {?>
											<a class="button ajax_add_to_cart_button btn btn-default product-btn" data-id-product="<?php echo $_smarty_tpl->tpl_vars['product']->value->id;?>
...
">
										...
										<?php }?>
									<?php }?>
									<a class="button lnk_view btn btn-default product-btn" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->getLink(), ENT_QUOTES, 'UTF-8', true);?>
