<?php /* Smarty version Smarty-3.1.19, created on 2017-01-02 18:38:54
         compiled from "/home/admiraltza/www/modules/jmsmegamenu/views/templates/admin/jmsmegamenu_manager/menulist.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2146263311586a902eb704e7-77414808%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8ed0481e43b4776ffc05f9d22a28b9ce770dfca0' => 
    array (
      0 => '/home/admiraltza/www/modules/jmsmegamenu/views/templates/admin/jmsmegamenu_manager/menulist.tpl',
      1 => 1482999911,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2146263311586a902eb704e7-77414808',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_586a902ebf4903_71903813',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_586a902ebf4903_71903813')) {function content_586a902ebf4903_71903813($_smarty_tpl) {?>
<div class="note row">
...
<h3>
  <i class="icon-list-ul"></i> <?php echo smartyTranslate(array('s'=>'Menu List','mod'=>'jmsmegamenu'),$_smarty_tpl);?>
	...
	<form name="adminForm" action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmsmegamenuManager'), ENT_QUOTES, 'UTF-8', true);?>
&configure=jmsmegamenu" method="post">
		<div id="jms-toolbar">				
				<a class="jms-tool btn-success" onclick="submitform('add','<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmsmegamenuManager'), ENT_QUOTES, 'UTF-8', true);?>
&configure=jmsmegamenu&addMenu');" title="Add New Menu">
					<i class="icon-plus"></i>
				</a>
				<a class="jms-tool btn-info" onclick="submitform('edit','<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmsmegamenuManager'), ENT_QUOTES, 'UTF-8', true);?>
&configure=jmsmegamenu');" title="Edit Menu">
					<i class="icon-edit"></i>
				</a>
				<a class="jms-tool btn-warning" onclick="submitform('deleteMenu','<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmsmegamenuManager'), ENT_QUOTES, 'UTF-8', true);?>
&configure=jmsmegamenu');" title="Delete Menus">
					<i class="icon-trash"></i>	
				</a>
				<a class="jms-tool btn-success" onclick="submitform('cStatus','<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmsmegamenuManager'), ENT_QUOTES, 'UTF-8', true);?>
&configure=jmsmegamenu&cStatus&status=1');" title="Enabled">
					<i class="icon-check"></i>
				</a>
				<a class="jms-tool btn-danger" onclick="submitform('cStatus','<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmsmegamenuManager'), ENT_QUOTES, 'UTF-8', true);?>
...
','<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmsmegamenuManager'), ENT_QUOTES, 'UTF-8', true);?>
&configure=jmsmegamenu',<?php if ($_smarty_tpl->tpl_vars['menu']->value['active']) {?>0<?php } else { ?>1<?php }?>)" title="<?php if ($_smarty_tpl->tpl_vars['menu']->value['active']) {?>Enabled<?php } else { ?>Disabled<?php }?>">
									...
									<a class="btn btn-default"
										href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmsmegamenuManager'), ENT_QUOTES, 'UTF-8', true);?>
&configure=jmsmegamenu&editMenu&mitem_id=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['menu']->value['mitem_id'], ENT_QUOTES, 'UTF-8', true);?>
" title="Edit">
										<i class="icon-edit"></i>									
									</a>
									<a class="btn btn-default"
