<?php /* Smarty version Smarty-3.1.19, created on 2017-01-04 16:29:48
         compiled from "/home/admiraltza/www/modules/jmsslider/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2067090462586d14ecab9be9-52964332%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f220cf7a6dae364ffa50e3a0ade20dfdcb9d48f8' => 
    array (
      0 => '/home/admiraltza/www/modules/jmsslider/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1482999911,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2067090462586d14ecab9be9-52964332',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_586d14ed355068_41821675',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_586d14ed355068_41821675')) {function content_586d14ed355068_41821675($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/admiraltza/www/tools/smarty/plugins/function.counter.php';
?>
...
-selectbutton" type="button" name="submitAddAttachments" class="btn btn-default">
						<i class="icon-folder-open"></i> <?php echo smartyTranslate(array('s'=>'Choose a file','mod'=>'jmsslider'),$_smarty_tpl);?>
			...
			<p class="help-block"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['pdesc'], ENT_QUOTES, 'UTF-8', true);?>
</p>			
			<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['image_baseurl']->value, ENT_QUOTES, 'UTF-8', true);?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields']->value[0]['form']['old_image'], ENT_QUOTES, 'UTF-8', true);?>
" class="img-thumbnail" />
			<input type="hidden" name="old_image" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields']->value[0]['form']['old_image'], ENT_QUOTES, 'UTF-8', true);?>
" />
			<?php }?>			
			</div>
		</div>
...
-name').val(file[file.length-1]);
	...
	<?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='layer_img') {?>
		<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['file_list'], ENT_QUOTES, 'UTF-8', true);?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '2067090462586d14ecab9be9-52964332');
content_586d14ed1583a1_83977450($_smarty_tpl);
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-01-04 16:29:49
         compiled from "/home/admiraltza/www/admin72364ma6i/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_586d14ed1583a1_83977450')) {function content_586d14ed1583a1_83977450($_smarty_tpl) {?>
