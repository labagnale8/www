<?php /* Smarty version Smarty-3.1.19, created on 2017-01-02 18:29:58
         compiled from "/home/admiraltza/www/modules/jmsblog/views/templates/admin/jmsblogform/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:863521624586a8e16438b34-28620309%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '69249932c70927d5ffd05a8fe529e48d63f362e5' => 
    array (
      0 => '/home/admiraltza/www/modules/jmsblog/views/templates/admin/jmsblogform/helpers/form/form.tpl',
      1 => 1482999911,
      2 => 'file',
    ),
    'b13a090d9eb9f3ecf2d8d1a63a1db67382594fcb' => 
    array (
      0 => '/home/admiraltza/www/admin72364ma6i/themes/default/template/helpers/form/form.tpl',
      1 => 1482862874,
      2 => 'file',
    ),
    '107829c59b64055e75cf0ffa3f892e7851e92cda' => 
    array (
      0 => '/home/admiraltza/www/admin72364ma6i/themes/default/template/helpers/form/form_group.tpl',
      1 => 1482862874,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '863521624586a8e16438b34-28620309',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_586a8e17162ce1_97913653',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_586a8e17162ce1_97913653')) {function content_586a8e17162ce1_97913653($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/admiraltza/www/tools/smarty/plugins/function.counter.php';
if (!is_callable('smarty_modifier_escape')) include '/home/admiraltza/www/tools/smarty/plugins/modifier.escape.php';
?>
...
thumb_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields']->value[0]['form']['images'][$_smarty_tpl->tpl_vars['language']->value['id_lang']], ENT_QUOTES, 'UTF-8', true);?>
" class="img-thumbnail" />
						<input type="hidden" name="image_old_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields']->value[0]['form']['images'][$_smarty_tpl->tpl_vars['language']->value['id_lang']], ENT_QUOTES, 'UTF-8', true);?>
" />
						<?php }?>
...
" type="file" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
" class="hide" />
...
-name" type="text" class="disabled" name="filename" readonly />
							<span class="input-group-btn">
								<button id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
-selectbutton" type="button" name="submitAddAttachments" class="btn btn-default">
									<i class="icon-folder-open"></i> <?php echo smartyTranslate(array('s'=>'Choose a file','mod'=>'jmsadvblog'),$_smarty_tpl);?>
...
?>
						...
						<script type="text/javascript">
							$().ready(function () {
								var input_id = 'tags_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
';
...
" >
					...
					<?php }?>
							...
							<input type="text" id="tags_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
" class="tagify updateCurrentText" name="tags_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['fields']->value[0]['form']['tags'][$_smarty_tpl->tpl_vars['language']->value['id_lang']], '', 'UTF-8');?>
" />
							<?php } else { ?>
							<input type="text" id="tags_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
" class="tagify updateCurrentText" name="tags_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
...
?>
								<li>
									<a href="javascript:hideOtherLanguage(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
...
<script type="text/javascript">
	hideOtherLanguage(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['defaultFormLanguage']->value, ENT_QUOTES, 'UTF-8', true);?>
);
</script>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '863521624586a8e16438b34-28620309');
content_586a8e16df0e34_77784687($_smarty_tpl);
...
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-01-02 18:29:58
         compiled from "/home/admiraltza/www/admin72364ma6i/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_586a8e16df0e34_77784687')) {function content_586a8e16df0e34_77784687($_smarty_tpl) {?>
