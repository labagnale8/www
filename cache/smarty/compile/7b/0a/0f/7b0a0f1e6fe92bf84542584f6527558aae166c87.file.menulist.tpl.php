<?php /* Smarty version Smarty-3.1.19, created on 2017-01-04 16:23:50
         compiled from "/home/admiraltza/www/modules/jmsvermegamenu/views/templates/admin/jmsvermegamenu_manager/menulist.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15823630586d1386e35b91-98423535%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7b0a0f1e6fe92bf84542584f6527558aae166c87' => 
    array (
      0 => '/home/admiraltza/www/modules/jmsvermegamenu/views/templates/admin/jmsvermegamenu_manager/menulist.tpl',
      1 => 1482999911,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15823630586d1386e35b91-98423535',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_586d1386eadd31_71180983',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_586d1386eadd31_71180983')) {function content_586d1386eadd31_71180983($_smarty_tpl) {?>
<div class="note row">
...
<div class="panel">
<h3>
  <i class="icon-list-ul"></i> <?php echo smartyTranslate(array('s'=>'Menu List','mod'=>'jmsvermegamenu'),$_smarty_tpl);?>
	...
	<form name="adminForm" action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmsvermegamenuManager'), ENT_QUOTES, 'UTF-8', true);?>
&configure=jmsvermegamenu" method="post">
		<div id="jms-toolbar">				
				<a class="jms-tool btn-success" onclick="submitform('add','<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmsvermegamenuManager'), ENT_QUOTES, 'UTF-8', true);?>
&configure=jmsvermegamenu&addMenu');" title="Add New Menu">
					<i class="icon-plus"></i>
				</a>
				<a class="jms-tool btn-info" onclick="submitform('edit','<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmsvermegamenuManager'), ENT_QUOTES, 'UTF-8', true);?>
&configure=jmsvermegamenu');" title="Edit Menu">
					<i class="icon-edit"></i>
				</a>
				<a class="jms-tool btn-warning" onclick="submitform('deleteMenu','<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmsvermegamenuManager'), ENT_QUOTES, 'UTF-8', true);?>
&configure=jmsvermegamenu');" title="Delete Menus">
					<i class="icon-trash"></i>	
				</a>
				<a class="jms-tool btn-success" onclick="submitform('cStatus','<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmsvermegamenuManager'), ENT_QUOTES, 'UTF-8', true);?>
&configure=jmsvermegamenu&cStatus&status=1');" title="Enabled">
					<i class="icon-check"></i>
				</a>
				<a class="jms-tool btn-danger" onclick="submitform('cStatus','<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmsvermegamenuManager'), ENT_QUOTES, 'UTF-8', true);?>
...
?>																
				...
				<?php }?>
				<div id="menus_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['menu']->value['mitem_id'], ENT_QUOTES, 'UTF-8', true);?>
" >					
					<div class="panel lvl<?php echo $_smarty_tpl->tpl_vars['menu']->value['level'];?>
">
						<div class="row">
							<div class="col-lg-2">
								<input type="checkbox" class="jms-checkbox" title="Checkbox" onclick="isChecked(this);" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['menu']->value['mitem_id'], ENT_QUOTES, 'UTF-8', true);?>
...
','<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmsvermegamenuManager'), ENT_QUOTES, 'UTF-8', true);?>
&configure=jmsvermegamenu',<?php if ($_smarty_tpl->tpl_vars['menu']->value['active']) {?>0<?php } else { ?>1<?php }?>)" title="<?php if ($_smarty_tpl->tpl_vars['menu']->value['active']) {?>Enabled<?php } else { ?>Disabled<?php }?>">
									...
									<a class="btn btn-default"
										href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmsvermegamenuManager'), ENT_QUOTES, 'UTF-8', true);?>
&configure=jmsvermegamenu&editMenu&mitem_id=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['menu']->value['mitem_id'], ENT_QUOTES, 'UTF-8', true);?>
" title="Edit">
										<i class="icon-edit"></i>									
									</a>
									<a class="btn btn-default"
