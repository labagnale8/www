<?php /* Smarty version Smarty-3.1.19, created on 2017-01-02 17:21:47
         compiled from "/home/admiraltza/www/modules/jmspagebuilder/views/templates/admin/jmspagebuilder_homepages/homelayout.tpl" */ ?>
<?php /*%%SmartyHeaderCode:482859432586a7e1bcd2047-99320353%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '30f23231f8f1e321fa4aa982f03e284f9c697997' => 
    array (
      0 => '/home/admiraltza/www/modules/jmspagebuilder/views/templates/admin/jmspagebuilder_homepages/homelayout.tpl',
      1 => 1482999912,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '482859432586a7e1bcd2047-99320353',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_586a7e1be35f94_32079559',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_586a7e1be35f94_32079559')) {function content_586a7e1be35f94_32079559($_smarty_tpl) {?>
...
?>
				<option value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['home']->value['id_homepage'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" <?php if ($_smarty_tpl->tpl_vars['home']->value['id_homepage']==mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['homepage']->value['id_homepage'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8')) {?>selected="selected"<?php }?>><?php ob_start();?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['home']->value['title'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php $_tmp1=ob_get_clean();?><?php echo $_tmp1;?>
		...
		<ul class="import-export">
			...
			<li><a class="export-link label-tooltip" data-original-title="Export Layout" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmspagebuilderHomepages'), ENT_QUOTES, 'UTF-8', true);?>
&configure=jmspagebuilder&export_id_homepage=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['homepage']->value['id_homepage'], ENT_QUOTES, 'UTF-8', true);?>
...
<form name="adminForm" action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmspagebuilderHomepages'), ENT_QUOTES, 'UTF-8', true);?>
...
?>
			<option value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['jsonfile']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['jsonfile']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</option> 	
			<?php } ?>
		</select>
		<button type="submit">Import</button>			
		<br /><span><?php echo smartyTranslate(array('s'=>'Files in','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
 <strong>modules/jmspagebuilder/json/</strong> Folder</span>
		<input type="hidden" name="import_id_homepage" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['homepage']->value['id_homepage'], ENT_QUOTES, 'UTF-8', true);?>
" /> 
</form>	
</div>
...
"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
	...
	<input type="hidden" name="lang_id_homepage" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['homepage']->value['id_homepage'], ENT_QUOTES, 'UTF-8', true);?>
" /> 
</form>
</div>
<div class="pagebuilder-panel">
	<div id="rowlist" class="lg-layout" data-id="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['homepage']->value['id_homepage'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
">
	<div class="rowlist">
...
?>
			<div class="row" data-layout="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['row']->value->layout, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" data-name="<?php if (isset($_smarty_tpl->tpl_vars['row']->value->name)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['row']->value->name, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>"  data-custom_class="<?php if (isset($_smarty_tpl->tpl_vars['row']->value->settings->custom_class)) {?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['row']->value->settings->custom_class, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php }?>" data-fluid="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['row']->value->settings->fluid, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" data-background_img="<?php if (isset($_smarty_tpl->tpl_vars['row']->value->settings->background_img)) {?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['row']->value->settings->background_img, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php }?>" data-background_size="<?php if (isset($_smarty_tpl->tpl_vars['row']->value->settings->background_size)) {?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['row']->value->settings->background_size, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php }?>" data-background_repeat="<?php if (isset($_smarty_tpl->tpl_vars['row']->value->settings->background_repeat)) {?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['row']->value->settings->background_repeat, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php }?>" data-background_position="<?php if (isset($_smarty_tpl->tpl_vars['row']->value->settings->background_position)) {?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['row']->value->settings->background_position, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php }?>" data-background_attachment="<?php if (isset($_smarty_tpl->tpl_vars['row']->value->settings->background_attachment)) {?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['row']->value->settings->background_attachment, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php }?>" data-hook="<?php if (isset($_smarty_tpl->tpl_vars['row']->value->settings->hook)) {?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['row']->value->settings->hook, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
<?php } else { ?>1<?php }?>">
				<div class="row-title">						
					<div class="pull-left">
						...
						<strong class="row-name"><?php if (isset($_smarty_tpl->tpl_vars['row']->value->name)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['row']->value->name, ENT_QUOTES, 'UTF-8', true);?>
<?php }?></strong>
					</div>
...
" data-custom_class="<?php if (isset($_smarty_tpl->tpl_vars['column']->value->settings->custom_class)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['column']->value->settings->custom_class, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" data-md_col="<?php if (isset($_smarty_tpl->tpl_vars['column']->value->settings->md_col)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['column']->value->settings->md_col, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" data-sm_col="<?php if (isset($_smarty_tpl->tpl_vars['column']->value->settings->sm_col)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['column']->value->settings->sm_col, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" data-xs_col="<?php if (isset($_smarty_tpl->tpl_vars['column']->value->settings->xs_col)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['column']->value->settings->xs_col, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" data-background_img="<?php if (isset($_smarty_tpl->tpl_vars['column']->value->settings->background_img)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['column']->value->settings->background_img, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" data-background_size="<?php if (isset($_smarty_tpl->tpl_vars['column']->value->settings->background_size)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['column']->value->settings->background_size, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" data-background_repeat="<?php if (isset($_smarty_tpl->tpl_vars['column']->value->settings->background_repeat)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['column']->value->settings->background_repeat, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" data-background_position="<?php if (isset($_smarty_tpl->tpl_vars['column']->value->settings->background_position)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['column']->value->settings->background_position, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" data-background_attachment="<?php if (isset($_smarty_tpl->tpl_vars['column']->value->settings->background_attachment)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['column']->value->settings->background_attachment, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>">
							<div class="column">
...
<input id="root_url" type="hidden" name="root_url" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['root_url']->value, ENT_QUOTES, 'UTF-8', true);?>
" />
<input id="ajax_url" type="hidden" name="ajax_url" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ajax_url']->value, ENT_QUOTES, 'UTF-8', true);?>
" />
<input id="current_url" type="hidden" name="current_url" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmspagebuilderHomepages'), ENT_QUOTES, 'UTF-8', true);?>
&configure=jmspagebuilder&editAddon=1" />
<input id="backend_url" type="hidden" name="backend_url" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmspagebuilderHomepages'), ENT_QUOTES, 'UTF-8', true);?>
" />
<div class="hidden">
...
<div class="hidden">
	<div class="row-settings">
		<div class="form-group">
			<label><?php echo smartyTranslate(array('s'=>'Row Name','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
</label>
			<input type="text" value="" data-attrname="name" class="form-control addon-input addon-name">
		</div>
		<div class="form-group">
			<label><?php echo smartyTranslate(array('s'=>'Hook','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
</label>
		...
		<div class="form-group">
			<label><?php echo smartyTranslate(array('s'=>'Custom CSS Class','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
</label>
		...
		<div class="form-group">
			<div class="checkbox"><label><input type="checkbox" data-attrname="fluid" class="addon-input input-fluid"><?php echo smartyTranslate(array('s'=>'Fluid Width','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
</label></div>
			<p class="help-block">Enable this option to make this row fluid. Fluid row will help you to publish full width content.</p>
		</div>
		<div class="form-group">
			<label><?php echo smartyTranslate(array('s'=>'Background Image','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
</label>
		...
		<div class="form-group">
			<label><?php echo smartyTranslate(array('s'=>'Background Size','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
</label>
		...
		<div class="form-group">
			<label><?php echo smartyTranslate(array('s'=>'Background Repeat','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
</label>
		...
		<div class="form-group">
			<label><?php echo smartyTranslate(array('s'=>'Background Position','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
</label>
		...
		<div class="form-group">
			<label><?php echo smartyTranslate(array('s'=>'Background Attachment','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
</label>
...
<div class="hidden">
	<div class="column-settings">
		...
		<div class="form-group md_col">
			<label><?php echo smartyTranslate(array('s'=>'Medium Layout','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
</label>
		...
		<div class="form-group sm_col">
			<label><?php echo smartyTranslate(array('s'=>'Tablet Layout','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
</label>
		...
		<div class="form-group xs_col">
			<label><?php echo smartyTranslate(array('s'=>'Mobile Layout','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
</label>
...
?>
			<li class="addon-cat-modules">
				<a class="addon-title" data-module="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['module']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
">			
					<img src="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['modules_url']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
/<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['module']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
/logo.png" />
					<span class="element-title"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['module']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</span>
					<span class="element-description"><?php if (isset($_smarty_tpl->tpl_vars['module']->value['short_desc'])) {?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['module']->value['short_desc'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php }?></span>
				</a>
			</li>
		<?php } ?>
    ...
    <div class="jms-modal-dialog">
        <div class="jms-modal-content">
            ...
            <div class="jms-modal-footer clearfix">
                <a href="javascript:void(0)" class="btn btn-success pull-left" id="save-settings" data-dismiss="modal"><?php echo smartyTranslate(array('s'=>'Apply','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
</a>
                <button class="btn btn-danger pull-left" data-dismiss="modal" aria-hidden="true"><?php echo smartyTranslate(array('s'=>'Cancel','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
</button>
            </div>
        </div>
    </div>
...
<div class="jms-modal" id="addon-modal" tabindex="-1" role="dialog" aria-labelledby="modal-label" aria-hidden="true" style="display: none;">
    <div class="jms-modal-dialog">
        <div class="jms-modal-content">
            ...
            <div class="jms-modal-body"></div>
            <div class="jms-modal-footer clearfix">
                <a href="javascript:void(0)" class="btn btn-success pull-left" id="save-addons" data-dismiss="modal"><?php echo smartyTranslate(array('s'=>'Apply','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
</a>
                <button class="btn btn-danger pull-left" data-dismiss="modal" aria-hidden="true"><?php echo smartyTranslate(array('s'=>'Cancel','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
</button>
            </div>
...
<div class="jms-modal fade" id="modal-addons" tabindex="-1" role="dialog" aria-labelledby="modal-addon-label" aria-hidden="true">
	<div class="jms-modal-dialog jms-modal-xlg">
		<div class="jms-modal-content">
			<div class="jms-modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h3 class="jms-modal-title" id="modal-addons-label"><?php echo smartyTranslate(array('s'=>'Add Addon or Module','mod'=>'jmspagebuilder'),$_smarty_tpl);?>
</h3>
...
<input type="hidden" name="mediatoken" id="mediatoken" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['mediatoken']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
<form name="layoutForm" action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmspagebuilderHomepages'), ENT_QUOTES, 'UTF-8', true);?>
&configure=jmspagebuilder" method="post">
<input type="hidden" name="jmsformjson" id="jmsformjson" value="" />
<input type="hidden" name="json_home_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['homepage']->value['id_homepage'], ENT_QUOTES, 'UTF-8', true);?>
" />
...
';
	...
	$(document).ready(function(){
			...
			tinySetup({
				...
				document_base_url : "<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['root_url']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"
			});
