			...
			{foreach from=$languages item=language}
				...
				{/if}
					<div class="col-lg-6">
						...
						<img src="{$image_baseurl|escape:'html':'UTF-8'}{$fields[0]['form']['simages'][$language.id_lang]|escape:'html':'UTF-8'}" class="img-thumbnail" />
						<input type="hidden" name="simage_old_{$language.id_lang|escape:'html':'UTF-8'}" value="{$fields[0]['form']['simages'][$language.id_lang]|escape:'html':'UTF-8'}" />
						{/if}
