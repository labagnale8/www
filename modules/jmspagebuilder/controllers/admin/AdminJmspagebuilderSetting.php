...
class AdminJmspagebuilderSettingController extends ModuleAdminController
{
    ...
    private function _postProcess()
    {
        ...
        if (Tools::isSubmit('submitSetting')) {
			...
			$res &= Configuration::updateValue('JPB_BLOGLAYOUT', Tools::getValue('JPB_BLOGLAYOUT'));
    ...
    public function renderSettingForm()
    {
		...
		$input_arr[] =  array(
                'type' => 'select',
                'label' => $this->l('Listing Layout'),
                'name' => 'JPB_LISTINGLAYOUT',
                'options' => array('query' => $_layouts,'id' => 'id','name' => 'name'),
                'tab' => 'layout'
            );	
		$input_arr[] =  array(
                'type' => 'select',
		...
		$input_arr[] =  array(
                'type' => 'select',
                'label' => $this->l('Blog Listing Layout'),
                'name' => 'JPB_BLOGLAYOUT',
                'options' => array('query' => $_layouts,'id' => 'id','name' => 'name'),
                'tab' => 'layout'
            );		
