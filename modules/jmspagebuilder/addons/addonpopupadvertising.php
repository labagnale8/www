    ...
    public function getInputs()
    {
        ...
        $inputs = array(
			...
			array(
				...
				'options' => array('displayTop','displayNav','displayTopColumn','displayHome','displayLeftColumn','displayRightColumn','displayFooter'),
                'default' => 'displayTop'
            ),
            array(
                'type' => 'text',
    ...
    {		
        ...
        $this->context->smarty->assign(
            array(
                ...
                'popup_title' => $addon->fields[0]->value->$id_lang,
