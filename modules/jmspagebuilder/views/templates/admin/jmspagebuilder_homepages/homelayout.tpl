...
<div class="layout-tools">		
		...
		<ul class="import-export">
			...
			<li><a class="export-link label-tooltip" data-original-title="Export Layout" href="{$link->getAdminLink('AdminJmspagebuilderHomepages')|escape:'html':'UTF-8'}&configure=jmspagebuilder&export_id_homepage={$homepage.id_homepage|escape:'html':'UTF-8'}"><i class="icon-download"></i></a></li>			
...
<form name="adminForm" action="{$link->getAdminLink('AdminJmspagebuilderHomepages')|escape:'html':'UTF-8'}&configure=jmspagebuilder" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="import_id_homepage" value="{$homepage.id_homepage|escape:'html':'UTF-8'}" /> 
</form>	
</div>
<div class="language-form" style="display:none;">
<form name="adminForm" action="{$link->getAdminLink('AdminJmspagebuilderHomepages')|escape:'html':'UTF-8'}&configure=jmspagebuilder" method="post">
	...
	<input type="hidden" name="lang_id_homepage" value="{$homepage.id_homepage|escape:'html':'UTF-8'}" /> 
</form>
</div>
			...
			<div class="row" data-layout="{$row->layout|escape:'htmlall':'UTF-8'}" data-name="{if isset($row->name)}{$row->name|escape:'html':'UTF-8'}{/if}"  data-custom_class="{if isset($row->settings->custom_class)}{$row->settings->custom_class|escape:'htmlall':'UTF-8'}{/if}" data-fluid="{$row->settings->fluid|escape:'htmlall':'UTF-8'}" data-background_img="{if isset($row->settings->background_img)}{$row->settings->background_img|escape:'htmlall':'UTF-8'}{/if}" data-background_size="{if isset($row->settings->background_size)}{$row->settings->background_size|escape:'htmlall':'UTF-8'}{/if}" data-background_repeat="{if isset($row->settings->background_repeat)}{$row->settings->background_repeat|escape:'htmlall':'UTF-8'}{/if}" data-background_position="{if isset($row->settings->background_position)}{$row->settings->background_position|escape:'htmlall':'UTF-8'}{/if}" data-background_attachment="{if isset($row->settings->background_attachment)}{$row->settings->background_attachment|escape:'htmlall':'UTF-8'}{/if}" data-hook="{if isset($row->settings->hook)}{$row->settings->hook|escape:'htmlall':'UTF-8'}{/if}" data-active="{if isset($row->settings->active)}{$row->settings->active}{else}1{/if}">
				...
				<div class="row-columns">
					{foreach from=$row->cols key=cindex item=column}
						<div class="{$column->className|escape:'htmlall':'UTF-8'}" data-custom_class="{if isset($column->settings->custom_class)}{$column->settings->custom_class|escape:'html':'UTF-8'}{/if}" data-md_col="{if isset($column->settings->md_col)}{$column->settings->md_col|escape:'html':'UTF-8'}{/if}" data-sm_col="{if isset($column->settings->sm_col)}{$column->settings->sm_col|escape:'html':'UTF-8'}{/if}" data-xs_col="{if isset($column->settings->xs_col)}{$column->settings->xs_col|escape:'html':'UTF-8'}{/if}" data-background_img="{if isset($column->settings->background_img)}{$column->settings->background_img|escape:'html':'UTF-8'}{/if}" data-background_size="{if isset($column->settings->background_size)}{$column->settings->background_size|escape:'html':'UTF-8'}{/if}" data-background_repeat="{if isset($column->settings->background_repeat)}{$column->settings->background_repeat|escape:'html':'UTF-8'}{/if}" data-background_position="{if isset($column->settings->background_position)}{$column->settings->background_position|escape:'html':'UTF-8'}{/if}" data-background_attachment="{if isset($column->settings->background_attachment)}{$column->settings->background_attachment|escape:'html':'UTF-8'}{/if}">
							<div class="column">
...
<input id="root_url" type="hidden" name="root_url" value="{$root_url|escape:'html':'UTF-8'}" />
<input id="ajax_url" type="hidden" name="ajax_url" value="{$ajax_url|escape:'html':'UTF-8'}" />
<input id="current_url" type="hidden" name="current_url" value="{$link->getAdminLink('AdminJmspagebuilderHomepages')|escape:'html':'UTF-8'}&configure=jmspagebuilder&editAddon=1" />
<input id="backend_url" type="hidden" name="backend_url" value="{$link->getAdminLink('AdminJmspagebuilderHomepages')|escape:'html':'UTF-8'}" />
<div class="hidden">
...
<form name="layoutForm" action="{$link->getAdminLink('AdminJmspagebuilderHomepages')|escape:'html':'UTF-8'}&configure=jmspagebuilder" method="post">
<input type="hidden" name="jmsformjson" id="jmsformjson" value="" />
<input type="hidden" name="json_home_id" value="{$homepage.id_homepage|escape:'html':'UTF-8'}" />
