...
{if $products}
    {if !$refresh}
        ...
        <ul class="clearfix display_list">
            <li>
                <a  id="hideBoughtProducts" class="button_account btn-default" href="#" onclick="WishlistVisibility('wlp_bought', 'BoughtProducts'); return false;" title="{l s='Hide products' mod='blockwishlist'}">
                    {l s='Hide products' mod='blockwishlist'}
                </a>
                <a id="showBoughtProducts" class="button_account btn-default" href="#" onclick="WishlistVisibility('wlp_bought', 'BoughtProducts'); return false;" title="{l s='Show products' mod='blockwishlist'}">
                    {l s='Show products' mod='blockwishlist'}
                </a>
            </li>
            {if count($productsBoughts)}
                <li>
                    <a id="hideBoughtProductsInfos" class="button_account btn-default" href="#" onclick="WishlistVisibility('wlp_bought_infos', 'BoughtProductsInfos'); return false;" title="{l s='Hide products' mod='blockwishlist'}">
                        {l s="Hide bought products' info" mod='blockwishlist'}
                    </a>
                    <a id="showBoughtProductsInfos" class="button_account btn-default" href="#" onclick="WishlistVisibility('wlp_bought_infos', 'BoughtProductsInfos'); return false;" title="{l s='Show products' mod='blockwishlist'}">
    ...
    <div class="wlp_bought">
		...
		<table class="wlp_bought_list table table-bordered table-responsive">
			<thead>
			<tr>
				<th class="first_item">{l s='Item' mod='blockwishlist'}</th>
				<th class="item">{l s='Description' mod='blockwishlist'}</th>
				<th class="item">{l s='Quantity' mod='blockwishlist'}</th>
				<th class="item">{l s='Priority' mod='blockwishlist'}</th>
				<th class="last_item">{l s='Action' mod='blockwishlist'}</th>
			</tr>
			</thead>
			<tbody>
					...
					{if $totModuloTablet == 0}{assign var='totModuloTablet' value=$nbItemsPerLineTablet}{/if}
						<tr>
							...
							<td class="item align_center"> 
								<a class="product-name" href="{$link->getProductlink($product.id_product, $product.link_rewrite, $product.category_rewrite)|escape:'html':'UTF-8'}">
							...
							<td class="item align_center">
								...
								<input type="text" class="form-control grey product_attribute" id="quantity_{$product.id_product}_{$product.id_product_attribute}" value="{$product.quantity|intval}" size="3"/>
							</td>
							<td class="item align_center">
